...
export default function PagoCreditoPage() {
  ...
  const montoAPagar = monto === '' ? toNumber(proxima?.total_informativo ?? proxima?.monto_cuota) : toNumber(monto)
      ...
      {result ? (
        <Comprobante
          ...
          filas={[
            ...
            { label: 'ITF estimado', value: <Money value={result.itf_estimado} /> },
            { label: 'Total debitado estimado', value: <Money value={result.total_debitado_estimado} /> },
          ...
          {cargando ? (
            ...
            <div className="bbva-confirm">
              ...
              <dl className="hb-dl">
                ...
                <div><dt>Capital</dt><dd><Money value={proxima?.capital_programado ?? proxima?.monto_cuota} /></dd></div>
                <div><dt>Interes</dt><dd><Money value={proxima?.interes_programado} /></dd></div>
                <div><dt>Seguro</dt><dd><Money value={proxima?.seguro_desgravamen} /></dd></div>
                <div><dt>ITF ref.</dt><dd><Money value={proxima?.itf_estimado} /></dd></div>
              ...
              {credito && (
                lq ? <Loader text="Consultando próxima cuota…" /> : proxima ? (
                  <div className="bbva-cuota-box">
                    ...
                    <Money value={proxima.total_informativo ?? proxima.monto_cuota} className="bbva-money-strong" />
                    <small>Capital <Money value={proxima.capital_programado ?? proxima.monto_cuota} /> Â· Interes <Money value={proxima.interes_programado} /> Â· Seguro <Money value={proxima.seguro_desgravamen} /> Â· ITF <Money value={proxima.itf_estimado} /></small>
                  </div>
                ) : (
              ...
              <div className="hb-grid-2">
                ...
                <div className="hb-field">
                  ...
                  <input id="monto" className="hb-input" type="number" min="0" step="0.01"
                    placeholder={proxima ? String(toNumber(proxima.total_informativo ?? proxima.monto_cuota)) : '0.00'}
